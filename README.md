...
3. It will prompt you: 1) Initial Repo Assessment 2) Second Pass 3) Re-test. Initial repo assessment will give the operator the attack surface. Operator will be given prompts of what it thinks are worth it and whats not. Second Pass will use the feedback from the initial repo assessment to inform the current test. Re-test will essentially look at the findings from the second pass and check against them. 
